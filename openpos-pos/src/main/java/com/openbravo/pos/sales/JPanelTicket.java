...
//        addTicketLine(prod, dPor, prod.getPriceSell());       
        ...
        if (dPor != 1.0)
        {
            // Wir müssen den Preis in Netto umrechnen!!!
            TaxInfo tax = taxeslogic.getTaxInfo(prod.getTaxCategoryID(), new Date());
            double priceNet = dPor / (1.0+tax.getRate());
            addTicketLine(prod, 1, priceNet);
        }
//        else if ((dPor == 1.0) && (dPor != prod.getPriceBuy()))
//        {
//            // Wir müssen den Preis in Netto umrechnen!!!
//            TaxInfo tax = taxeslogic.getTaxInfo(prod.getTaxCategoryInfo(), m_oTicket.getCustomer());
//            double priceNet = dPor / (1.0+tax.getRate());
//            addTicketLine(prod, 1, priceNet);
//        }
        else
    ...
    public class ScriptObject {
        ...
        public Object evalScript(String code, ScriptArg... args) throws ScriptException {
            ...
            script.put("ticketbag", m_ticketsbag);	// Added by me
...
/** This method is called from within the constructor to
    ...
    private void initComponents() {
        ...
        m_jPrice.setPreferredSize(new java.awt.Dimension(100, 64));
        m_jPrice.setRequestFocusEnabled(false);
        Font font = new Font("Arial",Font.BOLD,32);
        m_jPrice.setFont(font);
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 0;
