...
INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('31', 'Printer.TicketSimplified', 0, $FILE{/com/openbravo/pos/templates/Printer.TicketPreview.xml});
INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('32', 'Printer.TicketSimpleAction', 0, $FILE{/com/openbravo/pos/templates/Printer.TicketSimpleAction.xml});
...
CREATE TABLE CATEGORIES (
    ...
    PARENTID VARCHAR,
    IMAGE BYTEA,
    PRINTERID INTEGER DEFAULT 1 NOT NULL,
    PRIMARY KEY(ID),
...
CREATE TABLE TICKETS (
    ...
    DINERS INTEGER DEFAULT 0 NOT NULL,
    PRIMARY KEY (ID),
...
CREATE TABLE SALES (
    ...
    RECEIPTS_ID VARCHAR(256),
    RECEIPTS_MONEY VARCHAR(256) ,
    RECEIPTS_DATENEW TIMESTAMP ,
    RECEIPTS_ATTRIBUTES BLOB,

    TICKETS_ID VARCHAR(256) ,
    TICKETS_TICKETTYPE INTEGER DEFAULT 0 ,
    TICKETS_TICKETID INTEGER ,
    TICKETS_PERSON VARCHAR(256) ,
    TICKETS_CUSTOMER VARCHAR(256),
    TICKETS_STATUS INTEGER DEFAULT 0 ,
    TICKETS_DINERS INTEGER DEFAULT 0 ,

    TICKETLINES_TICKET VARCHAR(256) ,
    TICKETLINES_LINE INTEGER ,
    TICKETLINES_PRODUCT VARCHAR(256),
    TICKETLINES_ATTRIBUTESETINSTANCE_ID VARCHAR(256),
    TICKETLINES_UNITS DOUBLE PRECISION ,
    TICKETLINES_PRICE DOUBLE PRECISION ,
    TICKETLINES_TAXID VARCHAR(256) ,
    TICKETLINES_ATTRIBUTES BLOB,
    
    PAYMENTS_ID VARCHAR(256) ,
    PAYMENTS_RECEIPT VARCHAR(256) ,
    PAYMENTS_PAYMENT VARCHAR(1024) ,
    PAYMENTS_NOTE    VARCHAR(1024),
    PAYMENTS_TOTAL DOUBLE PRECISION ,
    PAYMENTS_TRANSID VARCHAR(1024),
    PAYMENTS_RETURNMSG BLOB,

    TAXLINES_ID VARCHAR(256) ,
    TAXLINES_RECEIPT VARCHAR(256) ,
    TAXLINES_TAXID VARCHAR(256) ,
    TAXLINES_BASE DOUBLE PRECISION ,
    TAXLINES_AMOUNT DOUBLE PRECISION ,
